...
class LocalizationMiddleware
{
    ...
    protected function getLocale(RequestInterface $req)
    {
    ...
    protected function localeFromPath(RequestInterface $req)
    {
        list(, $value) = explode('/', $req->getUri()->getPath());
        return $this->filterLocale($value);
    }

    protected function localeFromParam(RequestInterface $req)
    {
    ...
    protected function localeFromCookie(RequestInterface $req)
    {
    ...
    protected function localeFromHeader(RequestInterface $req)
    {
